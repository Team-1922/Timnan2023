...
public final class Constants {
 // public static class OperatorConstants {
    ...
    public static final double kZeroOffset = 0;//128.5
    public static final double kPivotMotorGatherAngle = 160; // 528

    public static final double kPivotMotorLowAngle = 10;//100
    public static final double kPivotMotorMidAngle = 15; //140
    public static final double kPivotMotorHighAngle = 20;//155
    public static final double kPivotMotorMinAngle = 0;
    public static final double kPivotMotorMaxAngle = 160;//540
    ...
    public static final double feetToMeters = .3048;
